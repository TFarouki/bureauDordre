    ...
    if(isset($_POST['json'])){
      ...
      if(file_exists($src)){
        ...
        if($db->count()>0){
          ...
          if($db->first()->stat != NULL){
            $stat = explode("-",$db->first()->stat)[1];
            $stat2 = $stat;
            if($stat != "link to"){
              $stat = NULL
            }
                ...
                //insert row into doc reg
                  ...
                  if(!$db->insert("upfile_register",$ar)){
                    ...
                    if($db->count()>0){
                        ...
                        if(!$db->update("register_bureaudordre",array('num_ordre'=>$json->id),array("fileID"=>$newId,"stat"=>"copy of-".$stat))){
                ...
                if(!$db->insert("upfile_register",$ar)){
                  ...
                  if($db->count()>0){
                      ...
                      if($stat == NULL){
                        ...
                        $ar = array("fileID"=>$newId,"stat"=>"copy of-".$stat);
                      }
